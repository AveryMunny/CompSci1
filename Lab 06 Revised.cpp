...
int main() //driver function
{
	...
	assert(length > 0 && width > 0 && area > 0 && "area must be a postive value \n");
	assert(length > 0 && width > 0 && area > 0 && "display's the values of length, width, and area \n");

	//calling the stub function getArea()
	getArea(length, width);

	//making the driver program
	cout << "The area of a rectagle with a length 3 and a width 4 is " << (getArea(3, 4)) << "\n";
	cout << "The area of a rectagle with a length 5 and a width 8 is " << (getArea(5, 8)) << "\n";
	cout << "The area of a rectagle with a length 12 and a width 2 is " << (getArea(12, 2)) << "\n";
...
double getArea(double length, double width)
{
	double area;
	area = length * width;
	cout << "The getArea function was called with the following arguements: \n";
	cout << "The length was: " << length << " and the width was: " << width << "\n";
